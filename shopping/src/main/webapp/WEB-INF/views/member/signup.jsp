				...
				<div class="row">
					...
					<div class="col-md-12"> 
						<div class="form-group">
							...
							<input type="text" class="form-control" name="userName" id="userName" required="required" placeholder="닉네임을 입력해주세요">
						</div>
					</div>
					
					<div class="col-md-12"> 
						<div class="form-group">
							<label class="label" for="userPhon">연락처</label>
							<input type="text" class="form-control" name="userPhon" id="userPhon" required="required" placeholder="연락처를 입력해주세요">
						</div>
					</div>
					...
					<div class="col-md-12">
						<div class="form-group">
							<input type="submit" id="signup_btn" name="signup_btn" value="회원가입" class="btn btn-primary" disabled="disabled">
						</div>
					</div>
				</div>
			</form>
